...
def establish_socket(role, target_ip="127.0.0.1", port=5000):
    ...
    if role == "sender":
        ...
        sender_socket.setsockopt(socket.SOL_SOCKET, 25, interface.encode('utf-8'))  # 25 is SO_BINDTODEVICE
        ...
        interface = "enp4s0"
        # Bind the socket to the specific interface
        receiver_socket.setsockopt(socket.SOL_SOCKET, 25, interface.encode('utf-8'))  # 25 is SO_BINDTODEVICE
        receiver_socket.bind(("172.31.43.45", port))
